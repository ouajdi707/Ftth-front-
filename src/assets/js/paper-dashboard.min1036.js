...
function debounce(n, t, r) {
    ...
    return function() {
        var a = this,
            e = arguments;
        clearTimeout(i), i = setTimeout(function() { i = null, r || n.apply(a, e) }, t), r && !i && n.apply(a, e)
    }
}
...
toggle_initialized = sidebar_mini_active = backgroundOrange = navbar_initialized = fixedTop = !(transparentDemo = transparent = !0), seq = 0, delays = 80, durations = 500, seq2 = 0, delays2 = 80, durations2 = 500,
    function() {
        ...
        showSidebarMessage: function(a) { try { $.notify({ icon: "nc-icon nc-bell-55", message: a }, { type: "info", timer: 4e3, placement: { from: "top", align: "right" } }) } catch (a) { console.log("Notify library is missing, please make sure you have the notifications library added.") } }
    };
